"""Human-readable materials and equipment list exporter."""
...
def ir_to_ingredients_text(ir: Any) -> str:
    """Backward-compatible alias for the historical ingredients export name."""
    return ir_to_materials_text(ir)
