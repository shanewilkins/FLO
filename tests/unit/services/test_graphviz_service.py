...
def test_postprocess_sppm_return_loop_edges_svg_uses_west_face_for_west_port_target(tmp_path: Path):
        contract = SimpleNamespace(
            rework_return_edges=[
                SimpleNamespace(source_id="rework", target_id="review", anchor_id="__sppm_rework_corridor_rework_review")
            ]
        )
...
def test_postprocess_sppm_return_loop_edges_svg_uses_west_face_for_port_qualified_source(tmp_path: Path):
        contract = SimpleNamespace(
            rework_return_edges=[
                SimpleNamespace(source_id="rework_quality", target_id="process", anchor_id="__sppm_rework_corridor_rework_quality_process")
            ]
        )
...
def test_postprocess_sppm_return_loop_edges_svg_rewrites_source_when_target_bounds_missing(tmp_path: Path):
        contract = SimpleNamespace(
            rework_return_edges=[
                SimpleNamespace(source_id="rework_quality", target_id="process", anchor_id="__sppm_rework_corridor_rework_quality_process")
            ]
