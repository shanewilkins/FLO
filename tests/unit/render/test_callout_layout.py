...
def test_build_edge_callout_attrs_near_source_uses_taillabel_and_offsets():
    attrs = build_edge_callout_attrs(table_html="<TABLE><TR><TD>A</TD></TR></TABLE>", near_source=True)
...
def test_build_edge_callout_attrs_centered_uses_xlabel_only():
    attrs = build_edge_callout_attrs(table_html="<TABLE><TR><TD>A</TD></TR></TABLE>", near_source=False)
